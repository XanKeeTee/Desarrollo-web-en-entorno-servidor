...
<head>
    <title>Ejercicio 9 - Palabra más Larga</title>
    <meta charset="utf-8" />
    ...
    <div class="container mt-4">
        <div class="card shadow-sm">
            <div class="card-header bg-secondary text-white">
                <h5 class="mb-0">Ejercicio 9 - Encontrar la palabra más larga</h5>
            </div>
            <div class="card-body">
                <form method="POST">
                    <div class="mb-3">
                ...
                if (isset($_POST['submit']) && isset($_POST['texto'])) {
                    ...
                    if (!empty($texto)) {
                        ...
                        echo '<h6>La palabra más larga encontrada es: '.htmlspecialchars($palabraMasLarga).'</h6>' ;
                    } else {
                        echo '<div class="alert alert-warning mt-3">Por favor, introduce algún texto.</div>';
                    }
                }
                ?>
            </div>
