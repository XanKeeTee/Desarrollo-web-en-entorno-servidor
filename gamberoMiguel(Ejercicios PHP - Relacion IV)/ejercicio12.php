        ...
        <div class="container mt-5">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">Ejercicio 12 - Serialización de objetos/arrays</h5>
                </div>
                <div class="card-body">
                    <?php
