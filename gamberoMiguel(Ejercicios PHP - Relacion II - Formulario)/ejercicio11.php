        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <form method ="POST">
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Nota1</label>
                        <input type="number" class="form-control" name="nota1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Faltas</label>
                        <input type="number" class="form-control" name="faltas">
                    </div>
