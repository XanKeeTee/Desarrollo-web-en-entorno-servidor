            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="number1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                    ...
                    <?php if ($_SERVER['REQUEST_METHOD'] === 'POST'): ?>
                        <?php
                            $n1 = isset($_POST['number1']) ? $_POST['number1'] : '';
                            $n2 = isset($_POST['number2']) ? $_POST['number2'] : '';
                        ?>
                        <div class="mt-3">
                            <div>Número 1: <?php echo htmlspecialchars($n1); ?></div>
                            <div>Número 2: <?php echo htmlspecialchars($n2); ?></div>
                        </div>
                    <?php endif; ?>
                    </form>
                </div>
